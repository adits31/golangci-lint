...
Add a new field to a [config struct](https://github.com/adits31/golangci-lint/blob/master/pkg/config/config.go).
Document it in [.golangci.example.yml](https://github.com/adits31/golangci-lint/blob/master/.golangci.example.yml).
Pass it to a linter.
