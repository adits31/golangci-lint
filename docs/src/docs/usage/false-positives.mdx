...
Please create [GitHub Issues here](https://github.com/adits31/golangci-lint/issues/new) if you find any false positives. We will add it to the default exclude list if it's common or we will fix underlying linter.
...
You can see more examples of using `//nolint` in [our tests](https://github.com/adits31/golangci-lint/tree/master/pkg/result/processors/testdata) for it.
